...
var cartmodel=require("../cart/cart.model")
var mailer=require('./mailer')
exports.addorder=function(req,res){
    var details=req.body
    if(details.email&&details.name&&details.price&&details.phone&&details.area&&details.city&&details.pincode&&details.items.length>0)
    {   
